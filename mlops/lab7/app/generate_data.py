...
from app.__init__ import DATA_SIZE, data_path
...
def generate():
    ...
    datasize = data.shape
    logger.info(
        f"=====> Time taken {etime:f} secs for data generation for the size of {datasize}"
    )

    # save data to pickle file
    train_path = data_path / "sensor_data.pkl"
