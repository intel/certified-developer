...
from daal4py import gbt_classification_prediction, get_gbt_model_from_xgboost
from mlflow import (
    create_experiment,
...
class HarvesterMaintenance:
    ...
    def train(self, ncpu: int = 4):
        ...
        xgb_model = train(self.parameters, xgb_train, num_boost_round=100)
        self.d4p_model = get_gbt_model_from_xgboost(xgb_model)
    ...
    def validate(self):
        ...
        float
            accuracy metric
        """
        daal_predict_algo = gbt_classification_prediction(
        ...
        daal_errors_count = count_nonzero(
            daal_prediction.prediction[:, 0] - ravel(self.y_test)
        )
        self.d4p_acc = abs(
