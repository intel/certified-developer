...
with app_tab:
    ...
    data_file = st.text_input(
        ...
        key="data",
        value="/home/ubuntu/certified-developer/MLOps_Professional/mlops_capstone/store/datasets/robot_maintenance/train.parquet",
    )
    ...
    scaler_destination = st.text_input(
        "Scaler Destination",
        key="scalerdest",
